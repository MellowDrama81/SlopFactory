...
The current 49 tests cover initialization, manifest/database creation, copied-library adoption, and open-library identity revalidation, exclusive locking, invalid library entries, managed import, hashing, progress, cancellation cleanup, duplicate handling, streamed in-library copies, folder/file organization, reviewed multi-file operations, and typed metadata ownership and filtering.
